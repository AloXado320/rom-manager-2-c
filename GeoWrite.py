...
"," if x[1]>>4==8 else "",'DL_'+y+hex(B2I(x[8:12])) if x[1]>>4==8 else ""),
8+min(4,(x[1]>>4==8)*4)]),
19:(lambda x,y:['GEO_ANIMATED_PART(%d,%d,%d,%d,%s)'%(x[1],(B2I(x[2:4])),(B2I(x[4:6])),(B2I(x[6:8])),'DL_'+y+hex(B2I(x[8:12]))),12,'STOREDL',x[8:12],'ext']),
20:(lambda x,y:['GEO_BILLBOARD_WITH_PARAMS{}({},{},{},{}{}{})'.format("_AND_DL" if x[1]>>4==8 else "",
x[1]&0xF,(B2I(x[2:4])),(B2I(x[4:6])),(B2I(x[6:8])),
"," if x[1]>>4==8 else "",'DL_'+y+hex(B2I(x[8:12])) if x[1]>>4==8 else ""),
8+min(4,(x[1]>>4==8)*4)]),
21:(lambda x,y:['GEO_DISPLAY_LIST(%d,%s)'%(x[1],'DL_'+y+hex(B2I(x[4:8]))),8,'STOREDL',x[4:8],'ext']),
